$(document).ready(function() {
	...
	news_text.each(function (index, value) {
		...
		if (_news_len > 360) {
			...
			$(this).after('<div class="hide"><div id="news-' + fbd + '" style="text-align:center;font-size:18px;z-index:9000;"><p><img src="images/logo.png" alt=""></p><h1>' + news_title[index].text + '</h1><p>' + value + '</p></div></div>');
		}
	});
});